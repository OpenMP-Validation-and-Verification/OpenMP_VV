//--------------- test_default_firstprivate_task.c -------------------------//
//
// OpenMP API Version 5.1 Aug 2021
//
// Tests the behavior of the default clause when the specified data-sharing attribute is firstprivate. This test focuses 
// on the use of the task construct. Firstprivate should allow any data initialized outside the task region to return to its original value
// after being manipulated within the task region.
