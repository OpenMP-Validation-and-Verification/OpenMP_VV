...
#pragma omp target teams distribute parallel for\
  ...
  OMPVV_WARNING_IF(raiseWarningOneThread == 4*SIZE_N, "The number of threads was always one, regardless of the nun_threads clause. This is not a compliance error in the specs");  
  return errors;
}
